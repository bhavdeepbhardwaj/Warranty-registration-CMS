                                    ...
                                    <form class="row g-3" method="POST"
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="div col-md-6 p-1">
                                                    <input type="text" class="form-select1" name="purchase_code" id="purchaseCode">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="div col-md-6 p-1">
                                                    <input type="file" class="form-select1 " name="purchase_invoice[]"
                                                        id="purchaseInvoice" multiple>
