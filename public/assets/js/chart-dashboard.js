 ...
 if (doughnut !== null) {
   var myDoughnutChart = new Chart(doughnut, {
    //  type: "doughnut",
     type: "pie",
     data: {
       labels: ["Notebook", "Convertible", "Accessories", "Smart Devices"],
    //    labels: ["completed", "unpaid", "pending", "canceled", "returned", "Broken"],
       datasets: [
         {
           label: ["Notebook", "Convertible", "Accessories", "Smart Devices"],
        //    label: ["completed", "unpaid", "pending", "canceled", "returned", "Broken"],
        //    data: [4100, 2500, 1800, 2300, 400, 150],
           data: [4100, 2500, 1800, 2300],
        //    backgroundColor: ["#88aaf3", "#50d7ab", "#662d91", "#f3d676", "#ed9090", "#a4d9e5"],
           backgroundColor: ["#88aaf3", "#50d7ab", "#662d91", "#f3d676"],
           borderWidth: 1,
           borderColor: ['#88aaf3','#29cc97','#662d91','#f3d676'],
           hoverBorderColor: ['#88aaf3', '#29cc97', '#662d91', '#f3d676'],
         }
       ]
     },
     options: {
    ...
    var configAcq = {
      ...
      data: {
        ...
        datasets: [
          {
            label: "Via Referral",
            backgroundColor: "rgba(165, 118, 201, .2)",
            borderColor: "rgba(102, 45, 145, .7)",
            data: acqData[0].first,
            lineTension: 0.3,
            pointBackgroundColor: "rgba(52, 116, 212,0)",
            pointHoverBackgroundColor: "rgba(102, 45, 145, .7)",
            pointHoverRadius: 3,
            pointHitRadius: 30,
            pointBorderWidth: 2,
